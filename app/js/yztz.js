...
(function ($, window, undefined) {
    ...
    var dialog = {
        ...
        info: function (msg) {
            var t = this, s = '';
            s += '<div class="db-content"><div style="padding:30px;">' + msg + '</div></div>';
            t.open(s, {type: 'info'});
        },
...
(function () {
    var userAgent = navigator.userAgent,
        ...
        isWin = /Windows Phone/i.test(userAgent),
        isMobile = isIOS || isAndroid || isBlackBerry || isWin;
    ...
    var browser = {
        ...
        windowsPhone: isWin,
        uc: isMobile && /UCBrowser/i.test(userAgent),
        mobile: isMobile
    };
    X.browser = browser;
}());
